...
async def getComments(firm):
    ...
    if (dictAux["rec"]['answers'][0]/n) <= 0.7: #ERRADO
        listComments.append({"code":"rec1","enunciado":"Você possui alguma rede social?","RespostaIdeal":"Não utilizo","Comentário":"BLA BLA BLA"},)
